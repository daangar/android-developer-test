package com.dgarcia.data.networking.base

import com.dgarcia.data.database.DB_ENTRY_ERROR
import com.dgarcia.data.networking.GENERAL_NETWORK_ERROR
import com.dgarcia.domain.model.Failure
import com.dgarcia.domain.model.HttpError
import com.dgarcia.domain.model.Result
import com.dgarcia.domain.model.Success
